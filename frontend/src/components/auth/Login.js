...
>
      <div className="bg-white/65 p-8 rounded-xl shadow-2xl w-full max-w-md mx-4 border border-[#8cb3e9] backdrop-blur-xl">
        ...
        <div className="mb-6 text-center">
          {/* <h1 className="text-3xl font-bold text-[#132780]">Welcome Back</h1> */}
          <p className="mt-2 font-bold text-[#132780]">Sign in to continue your learning journey</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-[#132780]">
            ...
            <a href="/register" className="text-[#e5496f] hover:text-[#d43a60] font-semibold transition">
              Sign Up
            </a>
          </p>
        </div>
